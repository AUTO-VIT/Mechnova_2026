...
/**
 * High-performance interactive particle canvas inspired by space frontier & robotics physics (movis-vitc).
 * Renders floating star-nodes, subtle connecting vectors, and mouse-repulsion physics.
 */

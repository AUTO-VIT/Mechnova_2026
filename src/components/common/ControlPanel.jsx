  ...
  return (
    <div
      className={`relative border bg-zinc-950/90 p-5 shadow-2xl backdrop-blur-md transition-all duration-200 ${
        hazardBorder
          ? 'border-red-600/60 shadow-[0_0_20px_rgba(220,38,38,0.2)]'
          : 'border-white/10 hover:border-white/20'
      } ${className}`}
    >
      {/* Top SCADA Border Accent Line */}
      <div className="absolute top-0 left-0 right-0 h-[2px] bg-gradient-to-r from-red-600 via-zinc-700 to-transparent" />

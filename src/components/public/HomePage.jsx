    ...
    <div className="w-full space-y-28">
      ...
      <section className="grid grid-cols-1 lg:grid-cols-12 gap-12 xl:gap-16 items-center pt-4 md:pt-10">
        ...
        <div className="lg:col-span-7 space-y-8">
          <div className="inline-flex items-center gap-2.5 px-4 py-1.5 rounded-full border border-[#855AB4]/30 bg-[#221545]/60 backdrop-blur-md">
            ...
            <span className="font-mono text-[11px] uppercase tracking-[0.25em] text-[#B26FCB]">
              MECHNOVA 2026 // ROBOTICS &amp; AUTONOMY
            </span>
          </div>
          ...
          <h1 className="font-display text-4xl sm:text-6xl md:text-7xl xl:text-8xl font-extrabold text-white tracking-tight leading-[1.04]">
            ...
            Systems <span className="text-[#B26FCB] font-light">&amp;</span> <br className="hidden sm:inline" />
            Intelligent Control
          </h1>
        ...
        {/* Right Wing (5 Cols) - Live Telemetry HUD */}
        <div className="lg:col-span-5 space-y-6">
          <div className="rounded-3xl border border-[#855AB4]/30 bg-[#221545]/70 backdrop-blur-2xl p-8 xl:p-10 space-y-8 shadow-[0_0_50px_rgba(104,56,141,0.25)] relative overflow-hidden">
            ...
            <div className="flex items-center justify-between border-b border-[#855AB4]/20 pb-5">
              ...
              <span className="font-mono text-[10px] text-[#B26FCB]/70">LIVE FEED</span>
            </div>
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-center justify-between py-2 border-b border-white/[0.04]">
                ...
                <span className={`font-mono text-xs uppercase font-semibold ${
                  eventData?.biddingOpen ? "text-[#855AB4]" : "text-zinc-500"
                }`}>
      ...
      <section className="space-y-8 pt-8">
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-4 border-b border-[#855AB4]/20 pb-4">
          <div>
            <span className="font-mono text-xs text-[#B26FCB] uppercase tracking-[0.25em] block mb-1">
              CHALLENGE DOMAINS
            </span>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {[
            ...
            <div
              key={d.code}
              className="border border-[#855AB4]/25 rounded-2xl p-7 bg-[#221545]/40 hover:border-[#B26FCB]/60 hover:bg-[#221545]/70 transition-all duration-300 space-y-4 group backdrop-blur-sm shadow-sm"
            >
              <span className="font-mono text-xs text-[#B26FCB] font-bold tracking-widest block">
                {d.code}
              </span>
      ...
      <section className="space-y-8 pt-4">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
          {[
            ...
            <div key={s.num} className="space-y-3 pt-6 border-t border-[#855AB4]/25 group hover:border-[#B26FCB] transition-colors duration-300">
              <span className="font-mono text-xs text-zinc-500 group-hover:text-[#B26FCB] font-bold block transition-colors">
                PHASE {s.num}
              </span>
